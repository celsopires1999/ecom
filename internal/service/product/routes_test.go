...
func TestProductServiceHandlers(t *testing.T) {
	...
	t.Run("should handle creating a product", func(t *testing.T) {
		payload := entity.CreateProductPayload{
			Name:        "test",
			Price:       100,
			Image:       "test.jpg",
...
func (m *mockUserStore) GetUserByID(userID int) (*entity.User, error) {
	return &entity.User{}, nil
}

func (m *mockUserStore) CreateUser(user entity.User) error {
	return nil
}
